...
namespace PowerBIEmbedded_AppOwnsData.Services
{
    public class EmbedService : IEmbedService
    {
        ...
        public async Task<bool> EmbedReport(string workspaceId, string reportId)
        {
        ...
        private string GetWebConfigErrors()
        {
            ...
            {
                return "WorkspaceId is empty. Please select a group you own and fill its Id in the URL";
            }

            // Workspace Id must be a Guid object.
            if (!Guid.TryParse(WorkspaceId, out result))
            {
                return "WorkspaceId must be a Guid object. Please select a workspace you own and fill its Id in the URL";
            }
